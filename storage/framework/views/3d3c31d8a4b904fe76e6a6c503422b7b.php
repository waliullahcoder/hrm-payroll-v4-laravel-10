<head>
    ...
    <!-- daterange picker -->
    <link rel="stylesheet" href="<?php echo e(asset('backend/bower_components/bootstrap-daterangepicker/daterangepicker.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('backend/bower_components/bootstrap-colorpicker/dist/css/bootstrap-colorpicker.min.css')); ?>">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('backend/dist/css/AdminLTE.css')); ?>">
    ...
    <!-- jQuery 3 -->
     ...
     <!-- My Stylesheet -->
    <link rel="stylesheet" href="<?php echo e(asset('backend/mystyle.css')); ?>">
    <!-- /My Stylesheet -->

    <!-- Wow -->
     <link rel="stylesheet" href="<?php echo e(asset('wow/animate.css')); ?>">
    <!--/Wow -->

<script src="<?php echo e(asset('backend/bower_components/jquery/dist/jquery.min.js')); ?>"></script>
</head><?php /**PATH D:\laragon\www\upgradelaravel\hrm-payroll-v4-laravel-10\resources\views/administrator/layouts/head.blade.php ENDPATH**/ ?>