...
<div class="content-wrapper wow fadeInDown" data-wow-duration=".5s" data-wow-delay=".2s">
  ...
  <section class="content">
    <div class="row">
      ...
      <form name="employee_salary_form" id="employee_salary_form" action="<?php echo e(url('/hrm/payroll/update/' . $salary['id'])); ?>" method="post">
        <?php echo e(csrf_field()); ?>
            ...
            <div class="form-horizontal">
              <div class="box-body">
                ...
                <div class="form-group<?php echo e($errors->has('basic_salary') ? ' has-error' : ''); ?>">
                  ...
                  <div class="col-sm-6">
                    <input type="number" name="basic_salary" class="form-control" id="basic_salary" value="<?php echo e($salary['basic_salary']); ?>" placeholder="<?php echo e(__('Enter basic salary..')); ?>">
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <div class="form-group<?php echo e($errors->has('house_rent_allowance') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="house_rent_allowance" value="<?php echo e($salary['house_rent_allowance']); ?>" class="form-control" id="house_rent_allowance" placeholder="<?php echo e(__('Enter house rent allowance..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('medical_allowance') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="medical_allowance" value="<?php echo e($salary['medical_allowance']); ?>" class="form-control" id="medical_allowance" placeholder="<?php echo e(__('Enter medical allowance..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('special_allowance') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="special_allowance" value="<?php echo e($salary['special_allowance']); ?>" class="form-control" id="special_allowance" placeholder="<?php echo e(__('Enter special allowance..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('provident_fund_contribution') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="provident_fund_contribution" value="<?php echo e($salary['provident_fund_contribution']); ?>" class="form-control" id="provident_fund_contribution" placeholder="<?php echo e(__('Enter special allowance..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('other_allowance') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="other_allowance" value="<?php echo e($salary['other_allowance']); ?>" class="form-control" id="other_allowance" placeholder="<?php echo e(__('Enter other allowance..')); ?>">
          ...
          <div class="box box-warning">
            ...
            <div class="box-body">
              <div class="form-group<?php echo e($errors->has('tax_deduction') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="tax_deduction" value="<?php echo e($salary['tax_deduction']); ?>" class="form-control" id="tax_deduction" placeholder="<?php echo e(__('Enter tax deduction..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('provident_fund_deduction') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="provident_fund_deduction" value="<?php echo e($salary['provident_fund_deduction']); ?>" class="form-control" id="provident_fund_deduction" placeholder="<?php echo e(__('Enter tax deduction..')); ?>">
              ...
              <div class="form-group<?php echo e($errors->has('other_deduction') ? ' has-error' : ''); ?>">
                ...
                <input type="number" name="other_deduction" value="<?php echo e($salary['other_deduction']); ?>" class="form-control" id="other_deduction" placeholder="<?php echo e(__('Enter other deduction..')); ?>">
        ...
        <div class="col-md-offset-6 col-md-6">
          <div class="box box-danger">
            ...
            <div class="box-footer">
              <button type="submit" class="btn btn-primary btn-flat pull-right"><i class="fa fa-edit"></i> <?php echo e(__('Update Details')); ?></button>
            </div>
          </div>
        </div>
        <!-- /.end.col -->
...
<?php echo $__env->make('administrator.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\upgradelaravel\hrm-payroll-v3-master\resources\views/administrator/hrm/payroll/edit_salary.blade.php ENDPATH**/ ?>