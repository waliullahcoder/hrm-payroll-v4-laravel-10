                                ...
                                <div class="col-lg-5 col-md-6">
                                    <div class="Login_form">
                                        <div class="Heading text-center">
                                            <h3><?php echo e(__('HRM & Payroll')); ?> <span><?php echo e(__('Soft. V3.0')); ?></span></h3>
                                        </div>
                                        <form action="<?php echo e(route('login')); ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                <div class="over_box">
                                                    <label for="InputEmail1" class="Label<?php echo e($errors->has('email') ? ' has-error' : ''); ?> has-feedback"><?php echo e(__('Email Address')); ?></label>
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="SideIcon"><img class="img-fluid" src="<?php echo e(asset('images/userLoginIcon01.png')); ?>" alt="Email Icon"></div>
                                                </div>
                                              
                                            </div>
                                            <div class="form-group">
                                                <div class="over_box">
                                                    <label for="InputPassword" class="<?php echo e($errors->has('password') ? ' has-error' : ''); ?> has-feedback"><?php echo e(__('Password')); ?></label>
                                                    ...
                                                    <?php endif; ?>
                                                    <div class="SideIcon"><img src="<?php echo e(asset('images/userLoginIcon02.png')); ?>" alt="Password Icon"></div>
                                                </div>
                                            </div>
                                        ...
                                        <form action="<?php echo e(route('login')); ?>" method="post">
                                            ...
                                            <?php endif; ?>
                                            <div class="form-group Buttons text-center">
                                                <button type="submit" class="btn Employee"><?php echo e(__('Employee Login')); ?></button>
                                            </div>
                                        </form>
                                        <div class="JoinUs">
                                            <p><?php echo e(__('Follow us')); ?></p>
                                ...
                                <div class="col-lg-7 col-md-6">
                                    <div class="Right_side">
                                        <div class="SoftWare_name m-auto text-center">
                                            <img class="img-fluid" src="<?php echo e(asset('images/Vector-Image.png')); ?>" alt="Software Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
...
</html><?php /**PATH D:\laragon\www\upgradelaravel\hrm-payroll-v4-laravel-10\resources\views/auth/login.blade.php ENDPATH**/ ?>